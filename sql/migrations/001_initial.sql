-- =============================================
-- AutoDialer Ultimate - Initial Database Schema
-- Version: 3.0.0
-- =============================================
...
CREATE INDEX IF NOT EXISTS idx_call_results_created_date ON call_results(DATE(created_at));
...
INSERT INTO users (username, password_hash, email, full_name, role, force_password_change) VALUES (
    'admin',
    -- bcrypt hash for 'admin' (12 rounds)
