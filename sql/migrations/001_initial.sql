-- =============================================
-- AutoDialer Ultimate - Migration 001: Initial Schema
-- Версия: 001
-- =============================================
-- ВКЛЮЧЕНО ВСЁ:
-- - 15 таблиц
...
-- =============================================
-- Создание таблицы миграций (если ещё нет)
-- =============================================
...
INSERT INTO settings (key, value, description, category) VALUES 
    ...
    ('login_rate_window', '300', 'Login rate window in seconds', '300'),
...
-- =============================================
INSERT INTO schema_migrations (version, name) VALUES ('001', 'Initial Complete Schema');
