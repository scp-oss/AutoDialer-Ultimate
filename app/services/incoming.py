...
class IncomingCallService:
    ...
    async def _log_audit(
        ...
        # из контекста запроса вместо вечного NULL. incoming_call_received
        # логируется с user_id=None (реально никто не инициировал) -
        # подзапросы по $1=NULL корректно дают NULL, ничего не ломается.
