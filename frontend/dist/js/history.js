...
const HistoryModule = {
    ...
    STATUS_LABELS: {
        ...
        unknown: 'Неизвестно',
        // DTMF 4/5-9/0/*/# - см. комментарий у CallResultStatus в
        // app/models/call.py: диалплан их шлёт давно, backend раньше
        // подменял на "failed", здесь подписей тоже не было.
        operator: 'Запрос оператора (нажал 4)',
        custom0: 'Доп. действие (нажал 0)',
        custom5: 'Доп. действие (нажал 5)',
        custom6: 'Доп. действие (нажал 6)',
        custom7: 'Доп. действие (нажал 7)',
        custom8: 'Доп. действие (нажал 8)',
        custom9: 'Доп. действие (нажал 9)',
        star: 'Доп. действие (нажал *)',
        hash: 'Доп. действие (нажал #)',
        invalid_dtmf: 'Неверный ввод'
    },
